...
// ... and replace with the below
        ...
        takeScreenshot(driver, "guardian.png");

        // Find the first word title of the webpage (the value inside the HTML
        // <title> element) and print it to the terminal
        String title = driver.getTitle();
        String firstWord = title.split(" ")[0];
        System.out.println("First word of the title: " + firstWord);
